...
export class IntradayTimeSeriesHeartRate implements IJSONSerializable, IJSONDeserializable<IntradayTimeSeriesHeartRate> {
    ...
    public fromJSON(json: any): IntradayTimeSeriesHeartRate {
        if (!json) return this
